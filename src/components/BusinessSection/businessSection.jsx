...
import DefaultRestaurantImage from "../../../public/Default-restaurant.jpg"; // Import the default image

const BusinessSection = ({ arr, image, businessCategory }) => {
                  ...
                  <div key={restaurant.id} className="carousel-item">
                    <div className="card card-compact bg-base-100 w-72 shadow-xl rounded-lg relative p-1">
                      ...
                      <figure className="rounded-lg h-[70%]">
                        {/* Use the default image if restaurant.images is not available */}
                        <img
                          src={restaurant.images || DefaultRestaurantImage} // Default image if no image is provided
                          alt="Business Image"
